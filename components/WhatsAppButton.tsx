...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ isChatOpen = false }) => {
  ...
  return (
    <a 
      ...
      className={`fixed bottom-[4.75rem] right-4 sm:bottom-[5.875rem] sm:right-8 z-[100] group flex items-center gap-3 bg-[#0a0a0a]/90 hover:bg-[#121212] text-white p-3 sm:px-5 sm:py-3 rounded-full shadow-[0_15px_35px_rgba(0,0,0,0.8)] border border-white/15 hover:border-[#25D366]/50 transition-all duration-300 hover:scale-[1.03] active:scale-95 backdrop-blur-2xl ${
    ...
    >
      ...
      {/* WhatsApp Icon Badge */}
      <div className="relative w-7 h-7 rounded-full bg-[#25D366]/15 border border-[#25D366]/30 flex items-center justify-center text-[#25D366] group-hover:bg-[#25D366] group-hover:text-white transition-all duration-300 shrink-0">
